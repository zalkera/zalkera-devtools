...
| 0.13.1 | 반영분 가드 메움 · 거짓 문면 정정 | Fable 기능 축 조건 이행 · **보안·성능 진행** | 진행 |
| **0.13.0** | `009a1ad`·`29f9d99`·`9fb2e01` + 성능 반영 | 설계(Fable 2판) + **Opus 3축**(기능·보안 조건부→이행 · 성능 통과) | **필요** — 고객 급건으로 Fable 앞서 발행 |
