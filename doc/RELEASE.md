...
| 판 | 커밋 | 받은 심의 | Fable |
|---|---|---|---|
| **0.20.0** | `64a06ed` | ⑴ memo184 T3(CLI 발행·되돌리기·버리기) — 설계(**Fable**, memo184) + **Opus 구현** + **Fable 3축**(1·2회전) + **Opus 조건 이행 확인**(3회전) · ⑵ 사이트 전환 경로 표시 — **Opus 단독**(설계 없음 · Opus 3축) | **부분** — Fable 이 본 것은 T3 의 설계와 1·2회전까지다. **2회전 반영분과 ⑵ 는 Opus 단독.** 재개 지점은 위 🔖 |
